...
Функция ПолучитьОписаниеОбработкиОбслуживания(АдресОбработки, ИмяОбработки = "", ПолучатьОбъект = Ложь) Экспорт
	...
	ВремОбработкаОбъект = ктв_ОбработкиОбслуживания.ПолучитьОбработкуОбъект(АдресОбработки, ОписаниеОбработки.ИмяОбработки, ОписаниеОбработки.ЭтоВнешняяОбработка);
...
Процедура ОбъектПриСозданииНаСервере(Отказ
	...
	ВремОбработкаОбъект = ктв_ОбработкиОбслуживания.ПолучитьОбработкуОбъект(Форма[ПутьКДаннымОбработкаАдресВХранилище]);
...
Функция ПолучитьАдресОбработкиОбслуживанияЭлемента(Элемент, ПутьКДаннымОбработки) Экспорт
	...
	ВремОбработка = Элемент[ПутьКДаннымОбработки].Получить();
	ВремОбработка = ?(ТипЗнч(ВремОбработка) = Тип("Строка"), ВремОбработка, ПолучитьНавигационнуюСсылку(Элемент, "Обработка"));
	
	Возврат ВремОбработка;
